...
## Post-approval data correction (implementation phase, 2026-07-15)

The approved mockup's "39 of 189 diagnostic calls produced a follow-up quote" was refined by the
per-job re-pull during read-model implementation: the June direct-service cohort is 187 (the
mockup's 189 double-counted two recurring-plan conversions — jobs 17064, 16397 — which the
verified quote-linked cohort requires as conversions), and 39 is exactly the same-day-quote
subset; a literal 0–30-day same-site rule yields 116. The implementation serves both statistics
with their rule strings disclosed. UI copy renders the corrected numbers — a deliberate,
documented deviation from approved mockup copy in favor of source truth.
