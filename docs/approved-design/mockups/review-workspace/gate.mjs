...
const shots = resolve(root, 'review-workspace', 'shots');
mkdirSync(shots, { recursive: true });

const PAGES = {
  quotes: {
    file: 'quotes.html',
    primarySel: '#trend',            // must be fully visible at 1440x900
    uniqueFigures: ['28.6%', '6.9%', '$10,045', '$145,225', '$1,674'],
  },
  jobs: {
    file: 'jobs.html',
    primarySel: '#trend',
    uniqueFigures: ['$165,448', '$308,386', '$216,186', '$92,200', '$50,738', '53.6%', '70.1%'],
  },
  materials: {
    file: 'materials.html',
    primarySel: '#catbar',
    uniqueFigures: ['$145,444'],
  },
  technicians: {
    file: 'technicians.html',
    primarySel: '#capacity',
    uniqueFigures: ['62%', '417.3h', '0.91×', '88%', '1,111.3h'],
  },
  commissions: {
    file: 'commissions.html',
    primarySel: '.lb .lrow:nth-child(3)', // first 3 leaderboard rows visible
    uniqueFigures: ['$246,147', '$269.29', '$12,495.73'],
  },
};
...
for (const [name, cfg] of Object.entries(PAGES)) {
  ...
  await page.goto('file://' + resolve(root, cfg.file));
  ...
  // 4. unique figures: appear exactly once outside svg/table/[data-viz]
